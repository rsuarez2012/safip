                            ...
                            <div class="table-responsive">
                                <table class="table" id="opbanc">
                                    ...
                                    <tbody>
                                        ...
                                        @if($operacion->tipo_operacion == "Deudas de Agencia de Viajes" || $operacion->tipo_operacion == "No Identificado")
                                        ...
                                        <tr>
                                            ...
                                            <td><select style="width: 60px" name="target[]" id="target[]" required="" class="form-control color{{$operacion->nro_operacion}}{{$operacion->utc}} target targetcolor{{$operacion->nro_operacion}}{{$operacion->utc}} color1">
