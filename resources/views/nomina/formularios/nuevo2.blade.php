...
<div class="tab-content">
    <div class="box padding_box1">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#mr">Datos Laborables</a></li>
            <li class="active"><a data-toggle="tab" href="#mc">Datos de Contrato</a></li>
        ...
        <div class="tab-content">
            ...
            <!--inicio del #mc-->
            <div class="tab-pane fade in active" id="mc" style="margin-top: 15px;">
                <form action="{{ route('manageNomina-store-B') }}" method="POST" class="form-horizontal" id="form-grande" accept-charset="UTF-8" enctype="multipart/form-data">
                {{ csrf_field() }}
                        <div class="col-sm-4">
