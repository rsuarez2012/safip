...
<div class="tab-content">
    <div class="box padding_box1">
        ...
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#mr">Datos Laborables</a></li><!--href="#mr"-->
            <li><a data-toggle="tab" >Datos de Contrato</a></li><!--href="#mc"-->
        </ul>
        <div class="tab-content">
            <div class="tab-pane fade in active" id="mp">
                <form action="{{ route('manageNomina-store-A') }}" method="POST" class="form-horizontal" id="form-grande" accept-charset="UTF-8" enctype="multipart/form-data">
                {{ csrf_field() }}
                    <div class="row"  style="margin-top: 15px;">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group has-feedback">
                                <label  class="col-sm-5 control-label">Seleccione el Pais</label>
                                <div class="col-sm-7">
                ...
                <form action="#" method="POST" class="form-horizontal" id="form-grande" accept-charset="UTF-8" enctype="multipart/form-data">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="pull-left col-sm-6">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="">Periodo de Pgo</label>
                                </div>
                            </div>
                            <div class="col-sm-8">
                                <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group pull-right">
                                        <button class="btn btn-success pull-right bancoN" style="color: #fff;" data-toggle="tooltip" data-placement="top" title="Nuevo Banco"><i class="fa fa-user-plus"></i></button>
                                </div>                           
                            </div> 
                        ...
                        <div class="pull-right col-sm-6">
                            ...
                            <div class="col-sm-8">
                                ...
                                <div class="form-group pull-right">
                                        <a class="btn btn-success pull-right" href="{{--Route('manageNomina-nuevo-A')--}}" style="color: #fff;" data-toggle="tooltip" data-placement="top" title="Nuevo Banco"><i class="fa fa-user-plus"></i></a>
                                </div>                           
                            </div> 
            ...
            <div class="tab-pane row" id="mc" style="margin-top: 15px;">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-sm-12 text-right">
                            <button type="submit" class="btn btn-danger" id="boton">Datos del Contrato <i class="fa fa-user-plus"></i></button>
