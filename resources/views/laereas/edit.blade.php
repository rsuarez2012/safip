...
@section('titulo', 'Editar Linea Aerea')
...
<div class="box padding_box1">
            ...
            <div class="x_title">
                <h2><i class="fa fa-building"></i>Editar Linea Aerea</h2>
                <hr>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="col-sm-8 col-sm-offset-2">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('manageLaerea-update-A',$aereas->id)}}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group {{ $errors->has('nombre') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="nombre" value="{{$aereas->nombre}}" placeholder="Nombre" >
                        ...
                        <div class="form-group {{ $errors->has('rif') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="rif" value="{{$aereas->rif}}" placeholder="RUC" >
                        ...
                        <div class="form-group {{ $errors->has('direccion') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="direccion" value="{{$aereas->direccion}}" placeholder="Direccion"  maxlength="255">
                        ...
                        <div class="form-group {{ $errors->has('telefono') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div  class="col-sm-10">
                            <input type="text" class="form-control" name="telefono" value="{{$aereas->telefono}}" placeholder="Telefono 1">
                        ...
                        <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-sm-10">
                            <input type="email" class="form-control" name="email" value="{{$aereas->email}}" placeholder="Email">
                        ...
                        <div class="form-group {{ $errors->has('web') ? ' has-error' : '' }} has-feedback">
                            ...
                            <input type="text" class="form-control" name="web" value="{{$aereas->web}}" placeholder="Web Empresarial">
                        ...
                        <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }} has-feedback">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="descripcion" value="{{$aereas->descripcion}}" placeholder="Descripcion">
