        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="box padding_box1">
                <div class="row">
                    <div class="col-md-8">
                        <div class="x_title">
                            <h2><i class="fa fa-users"></i>Pasajeros</h2>
                ...
                <div class="box-header">
                    <h4 class="box-title">Buscar Clientes</h4>
                    <div class="input-group input-group-sm ">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('adminbuscar')}}">
                            {!! csrf_field() !!}
                            <span class="input-group-btn">
                              <div style="padding-right: 0" class="col-md-10">

                                <input type="text" class="form-control" id="dato_buscado" name="dato">
                              </div>
                              <div style="padding-left: 0" class="col-md-2">
                                <button class="btn btn-info btn-flat" type="submit"  name="buscar" >Buscar!</button>
                              </div>
                     ...
                     <div class="col-md-2 pull-right" style="    margin-top: -3%;">
                        <a href="{{ route('manageCliente-create-A') }}" type="submit" class="btn btn-success" data-toggle="tooltip" data-placement="left" title="Nuevo Pasajero" style=" position: relative; z-index: 1;">
                ...
                <div class="table-responsive">
                    <table class="table" id="clientes" >
                        ...
                        @foreach ($clientes as $cliente)
                            <tr>
                                <td>{{$cliente->id}}</td>
                                <td>
                                    @if(!empty($cliente->empresas->nombre))
                                ...
                                <td>
                                    @if($cliente->direccion != "NoSetieneestedato")
                                        {{$cliente->direccion}}
                                    @endif
                                </td>
                                <td>
                                    @if($cliente->email != "NoSetieneestedato")
                                        {{$cliente->email}}
                                    @endif
                                </td>
                                <td>
                                    @if($cliente->telefono != "NoSetieneestedato")
                                        {{$cliente->telefono}}
                                    @endif
                                </td>
                                ...
                                <td>
                                    <a class="btn btn-warning btn-xs" href="{{ route('manageCliente-edit-A', $cliente->id) }}" data-toggle="tooltip" data-placement="left" title="Editar">
                                        <i class="fa fa-pencil fa-lg"></i>
                                    </a>

                                    <a class="btn btn-danger btn-xs" href="{{ route('manageCliente-destroy-A', $cliente->id) }}" onclick="return confirm('Seguro que desea Eliminar el Registro {{$cliente->id}}?')" data-toggle="tooltip" data-placement="left" title="Eliminar">
                    ...
                    {!! $clientes->appends(Request::only(['dato']))->render() !!} 
                    <?php
                    }else{
                    ?>
    ...
    <div class="modal-lg modal modalCorreo">
        <div class="modal-content2 modal-content">
            ...
            <div class="modal-body">
                ...
                <div class=" row">
                    <div class="col-sm-12 ">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('manageCorreo-envio-A')}}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
