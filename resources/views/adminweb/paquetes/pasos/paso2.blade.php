      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="col-xs-3">
            ...
            <input v-model="noches" type="number" class="form-control" placeholder="Cantidad de Noches">
          </div>
          <div class="col-xs-3">
            ...
            <div class="tab-pane active" id="tab_1">
              <div class="row" style="overflow-x: scroll;overflow: auto;">
                <div class="col-md-6" v-for="destinoPaquete of listados">
                  <table class="table table-bordered table-hover tabla_destinos" :id="destinoPaquete.destino.id">
                    <thead>
                      <tr>
...
<template id="datatable">
  <div>
    <table class="table table-bordered table-hover" id="enlazados">
      <thead>
        <tr>
          <td colspan="2"></td>
          <td colspan="4" class="text-center">PERUANO</td>
          <td colspan="4" class="text-center">EXTRANJERO</td>
          <td class="text-center">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(function () {
        ...
        var table = $(".tabla_destinos").DataTable();

        var table2 = $("#enlazados").DataTable();
