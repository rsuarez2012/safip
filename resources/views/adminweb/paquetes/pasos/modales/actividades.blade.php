            ...
            <div class="modal-body" >
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th class="col-xs-4">
                                ...
                                <div class="form-group" id="div_multiple1" v-show="filterRestaurants && dataActivity.type === 'restaurante'">
                                    <label>Seleccione otros destinos</label>
                                    <select class="form-control select2"
                                        multiple="multiple"
                                        data-placeholder="Seleccione los Destinos"
                    ...
                    <tbody>
                        <tr>
                            {{-- <td>
                                <input v-model="dataActivity.code" type="text" maxlength="180" class="form-control" placeholder="Codigo De La Actividad">
                            </td> --}}
                            <td>
                                <input v-model="dataActivity.name" type="text" {{-- maxlength="180" --}} class="form-control" placeholder="Nombre De La Actividad">
                            </td>
                            <td>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody v-if="day.actividades != null">
                        <template v-if="day.actividades.length > 0">
                            <tr v-for="(activities, index) in day.actividades">
