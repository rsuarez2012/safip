  <div class="modal" id="dia" style="overflow-y: scroll;overflow: auto;">
  <div class="modal-dialog" role="document" style="width: 1000px;margin: auto;">
      <div class="modal-content" style="width: 1000px;margin: auto;">
          <div class="modal-header" >
            <h3 id="titulo-modal-cotizacion" class="modal-title" style="display: inline;"><i class="fa fa-calendar-plus-o"></i> Nuevo Dia</h3>
