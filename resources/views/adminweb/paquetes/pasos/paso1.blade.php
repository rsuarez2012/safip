...
{{--<img  :src="route+'/storage/original/'+package.image" alt="Este dia no tiene una imagen">
                    ...
                    <img :src="route+'/storage/original/'+package.image" class="img-responsive" width="720px" height="80px" v-if="package.edit">
   ...
   $(document).ready(function(){
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function (e) {
            ...
            $('#preview').after('<img src="'+e.target.result+'" width="450" height="300"/>');
        }
