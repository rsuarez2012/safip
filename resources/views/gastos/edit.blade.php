...
@section('titulo', 'Editor de TGastos')
...
<div class="box padding_box1">
            ...
            <div class="x_title">
                <h2><i class="fa fa-building"></i>Editar Tipo de Gasto</h2>
                <hr>
                <div class="clearfix"></div>
            </div>
            <div class="x_content">
                <div class="col-sm-8 col-sm-offset-2">
                    <form class="form-horizontal" role="form" method="POST" action="{{route('manageGasto-update-A',$gastos->id)}}">
                        {!! csrf_field() !!}

                        <div class="form-group {{ $errors->has('tipo') ? ' has-error' : '' }} has-feedback">
                            <input type="text" class="form-control" name="tipo" value="{{$gastos->tipo_gasto}}" placeholder="Tipo" >
                        ...
                        <div class="form-group {{ $errors->has('descripcion') ? ' has-error' : '' }} has-feedback">
                            <input type="text" class="form-control" name="descripcion" value="{{$gastos->descripcion}}" placeholder="Descripcion" >
