...
@section('titulo', 'Editar Consolidadores')
      ...
      <div id="wrapper">
        <div id="login" class=" form" style="background-color: #FFF; padding: 0 20px; border-radius: 10px;">
            ...
            <div class="clearfix"></div>
              ...
              <div class="x_content">
                 ...
                 <div class="row"> 
                   <div class="col-md-10">
                        <div class="x_title">
                            <h2><i class="fa fa-building"></i> Registrar Consolidador</h2>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
          ...
          <div class="row">
             ...
             <form class="form-horizontal" role="form" method="POST" action="{{ route('manageConsolidador-store-A') }}" enctype="multipart/form-data">
                          {!! csrf_field() !!}
