...
<script type="text/javascript">
    ...
    $('#exportar').click(function(e){
        var htmltable= document.getElementById('dc');
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="box padding_box1">
            <div class="row">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{route('managePconsolidador-A-fecha')}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}

                    <div class="col-md-2" style="margin-left: 2%"><label>Desde:</label>
                  ...
                  <div class="col-md-2"><label>Hasta:</label>
        ...
        <div class="col-md-2 pull-right">
         <button type="" style="margin-top: 24px;padding: 7px; " class="btn btn-warning btn-xs btn abrirFiltro"  data-toggle="tooltip" data-placement="top" title="Filtros Generales" data-original-title="">
            <i class="fa fas fa-filter" aria-hidden="true"></i>
        </button>
    
     <button type="" style="margin-top: 24px;padding: 7px;" class="btn btn-warning btn-xs btn abrirPago"  data-toggle="tooltip" data-placement="top" title="Pago Multiple" data-original-title="">
...
<div class="modal-lg modal modale{{$deupagos->codigo}}{{$deupagos->nro_ticket}}">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"> <h4><i class="fa fa-pencil"></i> Modificar cuenta por pagar</h4></h4>
        </div>
        <div class="modal-body">
            <form class="form-horizontal row" role="form" method="POST" action="{{ route('managePagoC-storeb-A') }}" enctype="multipart/form-data">
                {!! csrf_field() !!}
          ...
          <div class="col-sm-6">
            <div class="form-group  {{ $errors->has('ticket') ? ' has-error' : '' }} has-feedback">
              ...
              <div class="form-group {{ $errors->has('dias') ? ' has-error' : '' }} has-feedback">
                  <label class="col-sm-4 control-label">Dias por Pagar</label>
                  <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            <div class="form-group {{ $errors->has('bancoe') ? ' has-error' : '' }}" id="disable1{{$deupagos->codigo}}{{$deupagos->nro_ticket}}">
              ...
              <div class="form-group {{ $errors->has('noperacion') ? ' has-error' : '' }} has-feedback" id="disable3{{$deupagos->codigo}}{{$deupagos->nro_ticket}}">
                  <label class="col-sm-4 control-label">Nº de Operacion</label>
                  <div class="col-sm-8">
        ...
        <div class="col-sm-6">
            <div class="form-group {{ $errors->has('bancor') ? ' has-error' : '' }}" id="disable2{{$deupagos->codigo}}{{$deupagos->nro_ticket}}">
              ...
              <div class="form-group  {{ $errors->has('tabono') ? ' has-error' : '' }} has-feedback">
                  <label class="col-sm-4 control-label">Total de Abono</label>
                  <div class="col-sm-8">
    ...
    <button id="debitar" value="{{$deupagos->codigo}}{{$deupagos->nro_ticket}}"  name="debitar"  class="btn label-success ">
    Debitar </button>
...
<div class="modal-lg modal modalFiltro">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('managePconsolidador-A-busquedag')}}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="box">
                    <div id="wrapper">
                        <div id="login" class=" form" style="background-color: #FFF;; border-radius: 10px;">
                            ...
                            <div class="row ">
                                <div class="col-sm-4"><h4 style="float: right;" >Estatus</h4></div>
                            ...
                            <div class="row">
                                <div class="col-md-3" style="margin-left: 41%;"><label>Desde:</label>
                                    <div class="form-group {{ $errors->has('fechai') ? ' has-error' : '' }} has-feedback">
                                        <input type="date" class="form-control" name="fechai" value="{{$fechai}}" placeholder="Fecha" >
                                        <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
                                        @if ($errors->has('fechai'))
