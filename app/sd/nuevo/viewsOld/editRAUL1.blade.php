...
<div class="row">
    <div class="col-md-12">
                        		...
                        		<div class="row">
                        			<div class="col-sm-12">
	                        			...
	                        			<div class="form-group selector-hoteles" style="display: none;">
	                        				...
	                        				<select class="form-control" multiple="multiple" id="destinos-hoteles" name="destinos[]">
	                        					@foreach($destinos as $destino)
      ...
      @endphp
     	...
     	@php
     		$as = array($enlazado->hotel->nombre);
     		//$b = round($enlazado->hotel->p_swb * 100) / 100;
	     	$resultado=0; 
     	@endphp
     	...
     	@endforeach
                                        ...
                                        <tr id="hotel_id{{$enlazado->id}}">                                      
     <td class="text-center">
     	{{$enlazado->id}}
     	{{ $enlazado->hotel->nombre }}
     </td>
                                          <td class="text-center">
                                          	{{ $enlazado->hotel->estrella }}</td>
																						@php
						                                    $total += ($enlazado->hotel->p_swb);
						                                @endphp
                                          <td class="text-center">

                                          	{{ $enlazado->hotel->p_swb }}
                                          </td>
                                          	@php
						                                    $p_dwb += ($enlazado->hotel->p_dwb);
						                                @endphp
                                          <td class="text-center">
                                          	{{ $enlazado->hotel->p_dwb }}</td>
                                          	@php
