...
class CategoriesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('e-shop.categories.index')->with('categories', $categories);
    }
    ...
    {
        return view('e-shop.categories.create');
    }
    ...
    {
        $category = Category::find($id);
        return view('e-shop.categories.edit')->with('category', $category);
    }
