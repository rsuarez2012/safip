...
return array(
    ...
    'properties' => [
        'creator'        => 'Safip QantuTravel',
        'lastModifiedBy' => 'Safip QantuTravel',
        'title'          => 'Excel File',
        'description'    => 'Import/Export Excel File',
        'subject'        => 'Import/Export Excel File',
        'keywords'       => 'safip, excel, export, import',
        'category'       => 'Excel',
        'manager'        => 'QantuTravel',
        'company'        => 'QantuTravel',
    ],
